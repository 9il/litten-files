...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      CK: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      iH: x0 => x0.Segmenter,
      iI: x0 => x0.pop(),
      iJ: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      ...
      kH: x0 => x0.wasmMemory,
      kI: (wasmFunction,f) => finalizeWrapper(f, function() { return wasmFunction(f,arguments.length) }),
      kJ: (x0,x1) => x0.removeItem(x1),
      l: a => a.length,
      ...
      nI: (x0,x1,x2,x3) => ({setDevice: x0,getDevice: x1,setTheme: x2,getTheme: x3}),
      nJ: (x0,x1) => x0.key(x1),
      ...
      qG: x0 => x0.tiltX,
      qH: (a, i) => a.splice(i, 1),
      qI: (x0,x1,x2) => ({type: x0,device: x1,theme: x2}),
      qJ: (x0,x1) => x0.querySelector(x1),
      r: s => s.trimLeft(),
      ...
      rH: a => a.pop(),
      rI: (x0,x1,x2) => x0.postMessage(x1,x2),
      rJ: (x0,x1) => x0.createElement(x1),
      s: (l, r) => l === r,
